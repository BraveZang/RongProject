...
@interface MainCoursePageOneVC ()<NetManagerDelegate,UICollectionViewDelegate,UICollectionViewDataSource>
{
    UIView* NoDataView;
...
@implementation MainCoursePageOneVC
...
- (void)getDataArrayFromServerIsRefresh:(BOOL)isRefresh {
    ...
    [self.net  Course_indexWithPage:[NSString stringWithFormat:@"%ld",(long)_page] Type:@"录播"];
