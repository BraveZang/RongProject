...
- (void)creatCell{
    ...
    //头像
    self.headView = [[UIImageView alloc] initWithFrame:CGRectMake(APP_WIDTH_6S(305.0), APP_HEIGHT_6S(9.0), APP_WIDTH_6S(32.0), APP_WIDTH_6S(32.0))];
    _headView.image = [UIImage imageNamed:@"RR_defaultHead"];
    _headView.layer.masksToBounds = YES;
    _headView.layer.cornerRadius = APP_WIDTH_6S(16.0);
